...
public RoomVO(int row_num, int room_id, String room_state, String adress, double mapx, double mapy,
		String room_location, String img, String phone, String room_start, String room_end, int room_cancel,
		boolean today_state) {
	super();
...
public boolean isToday_state() {
	return today_state;
}


public void setToday_state(boolean today_state) {
	this.today_state = today_state;
}
